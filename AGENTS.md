...
- Never create a component with huge number of lines, which may cause issue in the maintainability later. If it exceeds this, split it into smaller components automatically. Always separate UI from logic.
